...
/**
 * Esta clase es el entorno gr�fico del Sudoku.
...
public class sudokuGrafica extends JFrame {
	...
	//---FIJO para los n�meros iniciales que no son modificables--------------<
	private static int FIJO=0;
	//---OK para los n�meros agregados sin error estos son modificables-------<
	private static int OK=1;
	//---ERROR para los n�meros que con contengan por lo menos una colisi�n---<
	...
	//>---Celda que le dice a la etiqueta temporal que n�mero es-----<
	private Celda  aux;
	//>---Conexi�n con la l�gica----<
	...
	//>---se envia a un metodo de la l�gica------------------------<
	private static final int cantidadBlancos=30;
	//>---Es la clase encargada de enviar cada cierto tiempo una instrucci�n-------<
	 ...
	 * tablero
	 * -------
	 * Este metodo se encarga de llenar de paneles, que luego ser�n los cuadrantes del 
	 * tablero, en un panel m�s grande.
	 */
	 ...
	 * pnlInicio
	 * ---------
	 * En este panal se encuentra el bot�n que va a llenar el tablero y activar el reloj.
	 */
	 ...
	 * esta pasa a la etiqueta auxiliar y luego al hacer click en una etiqueta que no est�n fija
	 ...
	 * reloj
	 * -----
	 * Este m�todo es el encargado de preguntarle a la clase Reloj qu� im�genes debe poner en el 
	 ...
	 * pnlReloj
	 * --------
	 * Inicia el panel donde se encuentra el reloj y agrega im�genes al reloj antes de iniciar
	 * el juego.
	 */
	 ...
	 * verificar
	 * ---------
	 * Le pregunta a la l�gica si la celda ingredada tiene colisiones y de no tenerlas la
	 * agrega al al tablero y al sistema de verificaci�n de la l�gica.
	 * 
	 ...
	 * Aviso
	 * -----
	 * Muestra donde est�n las colisiones y muestra un cartal, luego de precionar aceptar en el cartel
	 * devuelve las celdas modificadas a su estado anterior
	 * @param anterior parametro de tipo entero se�alando el rotulo que estaba antes del cambio
	...
	private void aviso(int anterior,Celda cel,List<Celda> colisiones) {
		...
		JOptionPane.showMessageDialog(null, "No, ah� no se puede");
